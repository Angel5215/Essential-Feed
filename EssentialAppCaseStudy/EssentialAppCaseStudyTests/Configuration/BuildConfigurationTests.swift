...
final class BuildConfigurationTests: XCTestCase {
    private var pbxprojPath: String {
        ...
        return URL(fileURLWithPath: currentFilePath)
            .appendingPathComponent("../../EssentialAppCaseStudy.xcodeproj/project.pbxproj")
            .standardizedFileURL
    ...
    func test_hasExpectedNumberOfTargets() throws {
        ...
        XCTAssertEqual(targetCount, 2, "Expected 2 PBXNativeTarget entries in EssentialAppCaseStudy.xcodeproj")
    }
